...
@Component({
  ...
  template: `
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <!-- Search Console -->
      <section
        aria-label="Konsol Pencarian"
        class="bg-white rounded-3xl border border-slate-200/80 shadow-xs p-4 sm:p-5 mb-6 space-y-3"
      >
      ...
      <!-- Sort Header -->
      <section
        aria-label="Ringkasan Hasil dan Pengurutan"
        class="flex items-center justify-between mb-5 py-2.5 border-b border-slate-200"
      >
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
        ...
        <div class="lg:col-span-3 space-y-6">
          <!-- Transparency Banner -->
          <div
            class="p-4 rounded-3xl bg-blue-50/70 border border-blue-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs text-slate-700"
          >
            <div class="flex items-start gap-2.5">
              ...
              <div>
                ...
                <p class="text-slate-600 text-xs mt-0.5 leading-relaxed">
                  Semua harga adalah harga resmi pengembang. Estimasi cicilan dihitung berdasarkan
                  <strong>DP 20%</strong>, bunga efektif <strong>5.5% p.a.</strong>, tenor
          ...
          @if (loading()) {
            ...
            <div
              class="bg-white rounded-3xl border border-slate-200 p-8 sm:p-12 text-center space-y-5"
            >
              <div
                class="w-16 h-16 rounded-full bg-slate-100 text-slate-500 mx-auto flex items-center justify-center"
              >
              ...
              <div class="max-w-md mx-auto space-y-1.5">
                ...
                <p class="text-sm text-slate-500 leading-relaxed">
                  Kami tidak menemukan properti yang sesuai dengan filter saat ini. Coba perluas
                  pilihan kota atau rentang harga Anda.
                </p>
              </div>
              <button
                type="button"
