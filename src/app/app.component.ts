...
import { SiteFooterComponent } from './shared/components/footer.component';
import { SiteHeaderComponent } from './shared/components/header.component';
...
@Component({
  ...
  template: `
    <div class="min-h-screen flex flex-col bg-slate-50 text-slate-900">
      <app-site-header [favoritesCount]="favoritesCount()" [comparisonCount]="comparisonCount()" />
      <div class="flex-1">
        <router-outlet />
      </div>
      <app-site-footer />
