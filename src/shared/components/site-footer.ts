...
const OWNER = {
  ...
  socials: [
    ...
    { name: 'WhatsApp', url: 'https://wa.me/6282386473410?text=Halo%20Ikhwan%2C%20saya%20melihat%20portofolio%20Anda%20dan%20tertarik%20untuk%20berdiskusi%20terkait%20peluang%20kerja%20Frontend%20Engineer%20%2F%20proyek.' },
  ],
};
      ...
      <div class="mx-auto w-full max-w-7xl px-5 py-8 sm:px-8 sm:py-10 lg:px-12">
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-12 lg:gap-x-12">
          ...
          <div class="space-y-3 sm:col-span-1 lg:col-span-3">
            <h4 class="text-xs font-bold uppercase tracking-[0.12em] text-white">
              Menu Navigasi
            </h4>
        ...
        <!-- Bottom bar -->
        <div class="mt-8 flex flex-col gap-3 border-t border-slate-800 pt-5 sm:flex-row sm:items-center sm:justify-between">
